...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* Search box styles */
    nav.navbar.catshop-header .search-box {
      max-width: 400px !important;
      flex-grow: 1 !important;
      margin: 0 1rem !important;
    }

    nav.navbar.catshop-header .search-box .form-control {
    ...
    nav.navbar.catshop-header .search-box .form-control:focus {
      box-shadow: 0 0 0 0.2rem rgba(139, 111, 71, 0.25) !important;
      border-color: var(--hover-color) !important;
      outline: none !important;
    }

    nav.navbar.catshop-header .search-box .btn {
    ...
    nav.navbar.catshop-header .search-box .btn:hover {
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link <?= $currentPage == 'adoption.php' ? 'active' : '' ?>" href="adoption.php">
            <i class="bi bi-heart me-1"></i>Adoption
          </a>
        </li>
      </ul>
      ...
      <form class="d-flex search-box" action="search.php" method="GET">
        <input class="form-control" type="search" name="q" placeholder="Search for pets & products..." aria-label="Search" required>
