...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        if (isset($cat['user_id'])) {
            $owner_id = $cat['user_id'];
            $notif_message = "New adoption application received for " . htmlspecialchars($cat_name) . " from " . htmlspecialchars($applicant_name);
...
if ($cat_id) {
    ...
    if ($cat) {
        ...
        // Check if user has already applied (check by user_id in a new column, or by email)
        if ($current_user_id) {
                ...
                <form method="POST" action="" id="adoptionForm">
                    ...
                    <section class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="applicant_name" name="applicant_name" <?php echo $current_user_id ? 'required' : 'disabled'; ?>>
                        </div>

                        <div class="form-row">
                            <div class="form-group">
                                <label for="email">Email Address *</label>
                                <input type="email" id="email" name="email" <?php echo $current_user_id ? 'required' : 'disabled'; ?>>
                            </div>

                            <div class="form-group">
                                <label for="phone">Phone Number *</label>
                                <input type="tel" id="phone" name="phone" <?php echo $current_user_id ? 'required' : 'disabled'; ?>>
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="address">Full Address *</label>
                            <textarea id="address" name="address" rows="3" <?php echo $current_user_id ? 'required' : 'disabled'; ?>></textarea>
                        </div>
                    </section>
                    ...
                    <section class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <select id="home_type" name="home_type" <?php echo $current_user_id ? 'required' : 'disabled'; ?>>
                            ...
                            <div class="form-group checkbox-group">
                                <label>
                                    <input type="checkbox" name="has_yard" value="1" <?php echo $current_user_id ? '' : 'disabled'; ?>>
                                    I have a yard
                                </label>
                            </div>
                        </div>
                    ...
                    <section class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px;">
                                <label style="display: flex; align-items: center; font-weight: normal;">
                                    <input type="checkbox" name="living_with[]" value="Living alone" <?php echo $current_user_id ? '' : 'disabled'; ?>>
                                    <span style="margin-left: 8px;">Living alone</span>
                                </label>
                                <label style="display: flex; align-items: center; font-weight: normal;">
                                    <input type="checkbox" name="living_with[]" value="Spouse" <?php echo $current_user_id ? '' : 'disabled'; ?>>
                                    <span style="margin-left: 8px;">Spouse</span>
                                </label>
                                <label style="display: flex; align-items: center; font-weight: normal;">
                                    <input type="checkbox" name="living_with[]" value="Parents" <?php echo $current_user_id ? '' : 'disabled'; ?>>
                                    <span style="margin-left: 8px;">Parents</span>
                                </label>
                                <label style="display: flex; align-items: center; font-weight: normal;">
                                    <input type="checkbox" name="living_with[]" value="Children over 18" <?php echo $current_user_id ? '' : 'disabled'; ?>>
                                    <span style="margin-left: 8px;">Children over 18</span>
                                </label>
                                <label style="display: flex; align-items: center; font-weight: normal;">
                                    <input type="checkbox" name="living_with[]" value="Children below 18" <?php echo $current_user_id ? '' : 'disabled'; ?>>
                                    <span style="margin-left: 8px;">Children below 18</span>
                                </label>
                                <label style="display: flex; align-items: center; font-weight: normal;">
                                    <input type="checkbox" name="living_with[]" value="Relatives" <?php echo $current_user_id ? '' : 'disabled'; ?>>
                                    <span style="margin-left: 8px;">Relatives</span>
                                </label>
                                <label style="display: flex; align-items: center; font-weight: normal;">
                                    <input type="checkbox" name="living_with[]" value="Roommate(s)" <?php echo $current_user_id ? '' : 'disabled'; ?>>
                        ...
                        <div class="form-group">
                            ...
                            <div style="display: flex; gap: 20px;">
                                <label style="display: flex; align-items: center; font-weight: normal;">
                                    <input type="radio" name="household_allergic" value="Yes" <?php echo $current_user_id ? 'required' : 'disabled'; ?>>
                                    <span style="margin-left: 8px;">Yes</span>
                                </label>
                                <label style="display: flex; align-items: center; font-weight: normal;">
                                    <input type="radio" name="household_allergic" value="No" <?php echo $current_user_id ? 'required' : 'disabled'; ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="responsible_person" name="responsible_person" <?php echo $current_user_id ? 'required' : 'disabled'; ?>>
                        </div>

                        <div class="form-group">
                            <label for="financially_responsible">Who will be financially responsible for your pet's needs (i.e. food, vet bills, etc.)? *</label>
                            <input type="text" id="financially_responsible" name="financially_responsible" <?php echo $current_user_id ? 'required' : 'disabled'; ?>>
                        </div>

                        <div class="form-group">
                            <label for="vacation_care">Who will look after your pet if you go on vacation or in case of emergency? *</label>
                            <input type="text" id="vacation_care" name="vacation_care" <?php echo $current_user_id ? 'required' : 'disabled'; ?>>
                        </div>

                        <div class="form-group">
                            <label for="hours_alone">How many hours in an average workday will your pet be left alone? *</label>
                            <input type="text" id="hours_alone" name="hours_alone" placeholder="e.g., 6-8 hours" <?php echo $current_user_id ? 'required' : 'disabled'; ?>>
                        </div>

                        <div class="form-group">
                            <label for="introduction_steps">What steps will you take to introduce your new pet to his/her new surroundings? *</label>
                            <textarea id="introduction_steps" name="introduction_steps" rows="4" <?php echo $current_user_id ? 'required' : 'disabled'; ?>></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div style="display: flex; gap: 20px;">
                                <label style="display: flex; align-items: center; font-weight: normal;">
                                    <input type="radio" name="family_support" value="Yes" <?php echo $current_user_id ? 'required' : 'disabled'; ?>>
                                    <span style="margin-left: 8px;">Yes</span>
                                </label>
                                <label style="display: flex; align-items: center; font-weight: normal;">
                                    <input type="radio" name="family_support" value="No" <?php echo $current_user_id ? 'required' : 'disabled'; ?>>
                                    <span style="margin-left: 8px;">No</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group checkbox-group">
                            <label>
                                <input type="checkbox" name="has_other_pets" value="1" id="hasOtherPets" <?php echo $current_user_id ? '' : 'disabled'; ?>>
                        ...
                        <div class="form-group" id="otherPetsGroup" style="display: none;">
                            ...
                            <textarea id="other_pets_details" name="other_pets_details" rows="3" <?php echo $current_user_id ? '' : 'disabled'; ?>></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="experience_with_cats" name="experience_with_cats" rows="4" 
                                      placeholder="Have you owned cats before? How long?" <?php echo $current_user_id ? 'required' : 'disabled'; ?>></textarea>
                        </div>

                        <div class="form-group">
                            <label for="reason_for_adoption">Why do you want to adopt this cat? *</label>
                            <textarea id="reason_for_adoption" name="reason_for_adoption" rows="4" <?php echo $current_user_id ? 'required' : 'disabled'; ?>></textarea>
                        </div>
                    </section>
                    ...
                    <section class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="veterinarian_info" name="veterinarian_info" rows="2" 
                                      placeholder="Veterinarian name, clinic, phone number" <?php echo $current_user_id ? '' : 'disabled'; ?>></textarea>
                        </div>

                        <div class="form-group">
                            <label for="references">Personal References</label>
                            <textarea id="references" name="references" rows="3" 
                                      placeholder="Name and contact information of 2 personal references" <?php echo $current_user_id ? '' : 'disabled'; ?>></textarea>
                        </div>
                    </section>
                    ...
                    <section class="form-section">
                        <div class="agreement-box">
                            ...
                            <label class="checkbox-group">
                                <input type="checkbox" id="agreement" <?php echo $current_user_id ? 'required' : 'disabled'; ?>>
